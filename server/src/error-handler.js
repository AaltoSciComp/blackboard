// This middleware is adapted from a blog post on December 7, 2020:
// https://simonplend.com/how-to-create-an-error-handler-for-your-express-api/
// Copyright (C) 2025 Simon Plenderleith
...
function errorHandlerMiddleware(error, request, response, next) {
	...
	// IP cannot be easily fetched in docker swarm mode. Wait for improvements...
	//var ip = request.headers['x-forwarded-for'] || request.socket.remoteAddress || null;
	//logErrorMessage(ip + ': ' + errorMessage);
